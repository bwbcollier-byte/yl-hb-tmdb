#!/bin/bash
# Infinite loop script for TMDb Film Top Rated Mining
# Designed to run in screen/tmux locally on your server

SLEEP_BETWEEN_ROUNDS=3600
export MAX_PAGES="${MAX_PAGES:-5}"
export LIMIT="${LIMIT:-0}"
export MINING_ENDPOINT="/movie/top_rated"
export MEDIA_TYPE="movie"
export WORKFLOW_FILE="tmdb-movie-top-rated-mining.yml"

echo "=========================================="
echo " Starting TMDb Film Top Rated Mining - INFINITE LOOP "
