#!/bin/bash
# Infinite loop script for TMDb Film Now Playing Mining
# Designed to run in screen/tmux locally on your server

SLEEP_BETWEEN_ROUNDS=3600
export MAX_PAGES="${MAX_PAGES:-5}"
export LIMIT="${LIMIT:-0}"
export MINING_ENDPOINT="/movie/now_playing"
export MEDIA_TYPE="movie"
export WORKFLOW_FILE="tmdb-movie-now-playing-mining.yml"

echo "=========================================="
echo " Starting TMDb Film Now Playing Mining - INFINITE LOOP "
