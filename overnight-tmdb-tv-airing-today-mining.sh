#!/bin/bash
# Infinite loop script for TMDb TV Airing Today Mining
# Designed to run in screen/tmux locally on your server

SLEEP_BETWEEN_ROUNDS=3600
export MAX_PAGES="${MAX_PAGES:-5}"
export LIMIT="${LIMIT:-0}"
export MINING_ENDPOINT="/tv/airing_today"
export MEDIA_TYPE="tv"
export WORKFLOW_FILE="tmdb-tv-airing-today-mining.yml"

echo "=========================================="
echo " Starting TMDb TV Airing Today Mining - INFINITE LOOP "
