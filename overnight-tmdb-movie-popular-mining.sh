#!/bin/bash
# Infinite loop script for TMDb Film Popular Mining
# Designed to run in screen/tmux locally on your server

SLEEP_BETWEEN_ROUNDS=3600
export MAX_PAGES="${MAX_PAGES:-5}"
export LIMIT="${LIMIT:-0}"
export MINING_ENDPOINT="/movie/popular"
export MEDIA_TYPE="movie"
export WORKFLOW_FILE="tmdb-movie-popular-mining.yml"

echo "=========================================="
echo " Starting TMDb Film Popular Mining - INFINITE LOOP "
